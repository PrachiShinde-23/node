...
* \[[`597bfefbe1`](https://github.com/nodejs/node/commit/597bfefbe1)] - **doc**: deprecate instantiating `node:http` classes without new (Yagiz Nizipli) [#58518](https://github.com/nodejs/node/pull/58518)
